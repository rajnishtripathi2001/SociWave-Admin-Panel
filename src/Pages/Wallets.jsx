...
export default function Wallets() {
  ...
  const walletState = (command)=>{
    ...
    axios.post("https://flask-backend.up.railway.app/walletState",{task})
    .then((res)=>{
          ...
          <div className="w-full flex flex-col">
            <table className="w-full ">
              <tr>
                ...
                <td className="border-2 w-1/2 p-1 align-top">
                  Status : <span className="text-blue-500">{userData.status}</span>
                </td>
              </tr>
              <tr>
                <td className="border-2 w-1/2 p-1 align-top">
                  Balance : <span className="text-blue-500">{userData.balance}</span>
                </td>
                <td className="border-2 w-1/2 p-1 align-top">
                  Spending : <span className="text-blue-500">{userData.spending}</span>
                </td>
              </tr>
              <tr>
                <td className="border-2 w-1/2 p-1 align-top">
            ...
            <div className="mt-7 flex">
              <div className="w-4/5 h-[55vh]">
                ...
                {transactionScreen ? <Transactions walletID={walletID} /> : null}
              </div>
              ...
              <div className="w-1/5 h-[55vh] px-5">
                ...
                <button className="bg-green-500 text-white px-4 py-2 w-full rounded-md my-1" onClick={()=>walletState("Active")}>
                  Activate Wallet
                </button>
                <button className="bg-red-500 text-white px-4 py-2 w-full rounded-md my-1" onClick={()=>walletState("Seized")}>
                  Seize Wallet
                </button>
              </div>
            </div>
